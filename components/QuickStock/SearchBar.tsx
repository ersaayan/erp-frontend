                        ...
                        <div className="grid gap-2">
                            <div className="flex items-center space-x-2">
                                <Checkbox
                                    ...
                                    onCheckedChange={(checked) => 
                                        setSearchOptions(prev => ({ ...prev, barcodeOnly: checked as boolean }))
                                    }
                                />
                            ...
                            <div className="flex items-center space-x-2">
                                <Checkbox
                                    ...
                                    onCheckedChange={(checked) => 
                                        setSearchOptions(prev => ({ ...prev, stockCodeOnly: checked as boolean }))
                                    }
                                />
                            ...
                            <div className="flex items-center space-x-2">
                                <Checkbox
                                    ...
                                    onCheckedChange={(checked) => 
                                        setSearchOptions(prev => ({ ...prev, stockNameOnly: checked as boolean }))
                                    }
                                />
                            ...
                            <div className="flex items-center space-x-2">
                                <Checkbox
                                    id="searchInBarcodes"
                                    checked={searchOptions.searchInBarcodes}
                                    onCheckedChange={(checked) => 
                                        setSearchOptions(prev => ({ ...prev, searchInBarcodes: checked as boolean }))
                                    }
                                />
                                <Label htmlFor="searchInBarcodes">Barkodlarda Ara</Label>
                            </div>
                            <div className="flex items-center space-x-2">
                                <Checkbox
                                    id="searchInCodes"
                                    checked={searchOptions.searchInCodes}
                                    onCheckedChange={(checked) => 
                                        setSearchOptions(prev => ({ ...prev, searchInCodes: checked as boolean }))
                                    }
                                />
                                <Label htmlFor="searchInCodes">Kodlarda Ara</Label>
                            </div>
                            <div className="flex items-center space-x-2">
                                <Checkbox
                                    id="searchInXXL"
                                    checked={searchOptions.searchInXXL}
                                    onCheckedChange={(checked) => 
                                        setSearchOptions(prev => ({ ...prev, searchInXXL: checked as boolean }))
                                    }
                                />
                                <Label htmlFor="searchInXXL">Stok bulunamadığında XML stoklarında Ara</Label>
                            </div>
                        </div>
                    </div>
                </PopoverContent>
