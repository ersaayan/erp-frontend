...
import { usePosPaymentForm } from "./usePosPaymentForm";
...
const PosPaymentForm: React.FC<PosPaymentFormProps> = ({
                                                           current,
                                                           onClose,
                                                       }) => {
    ...
    } = usePosPaymentForm(current.currentCode);
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            toast({
                title: "Success",
                description: "POS payment completed successfully",
            });
            onClose();
        } catch (error) {
            toast({
