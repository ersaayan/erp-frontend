...
import { useCashCollectionForm } from "./useCashCollectionForm";
...
const formSchema = z.object({
    ...
    vaultId: z.string().min(1, "Vault selection is required"),
    branchCode: z.string().min(1, "Branch selection is required"),
    description: z.string().optional(),
});

const CashCollectionForm: React.FC<CashCollectionFormProps> = ({
                                                                   current,
                                                                   onClose,
                                                               }) => {
    ...
    } = useCashCollectionForm(current.currentCode);
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            toast({
                title: "Success",
                description: "Cash collection completed successfully",
            });
            onClose();
        } catch (error) {
            toast({
